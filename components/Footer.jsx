...
export default function Footer() {
  ...
  const iconClass =
    "h-5 w-5 md:h-6 md:w-6 fill-current text-black dark:text-white hover:text-blue dark:hover:text-light-lime";
    ...
    >
      <div className="flex flex-col items-center p-1">
        <div className={`flex flex-row items-center ${styles.social}`}>
          ...
          <a
            href="https://www.instagram.com/_zcyn.my_/"
            target="_blank"
            rel="noopener noreferrer"
